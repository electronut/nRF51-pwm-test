/* 
   ...
   Demonstration of PWM and GPIOTE events.
...
int main(void)
{
    ...
    app_pwm_config_t pwm1_cfg = 
      APP_PWM_DEFAULT_CONFIG_2CH(5000L, 21, 22);
    ...
    app_pwm_config_t pwm2_cfg = 
      APP_PWM_DEFAULT_CONFIG_2CH(5000L, 23, 24);
    ...
    while(1) {
      ...
      while (app_pwm_channel_duty_set(&PWM2, 1, val) == NRF_ERROR_BUSY);
